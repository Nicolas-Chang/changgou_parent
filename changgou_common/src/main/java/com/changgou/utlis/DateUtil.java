...
/*        Date date = toDayStartHour(new Date());
        ...
        for (int i = 0; i < 12; i++) {
            Date dateHour = addDateHour(date, i * 2);
            arrayList.add(dateHour);
        }

        for (Date date1 : arrayList) {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd:HH-mm-ss");
            String s = simpleDateFormat.format(date1);
            System.out.println(s);
        }*/
        List<Date> menus = getDateMenus();
        for (Date menu : menus) {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd:HH-mm-ss");
            String menuS = simpleDateFormat.format(menu);
