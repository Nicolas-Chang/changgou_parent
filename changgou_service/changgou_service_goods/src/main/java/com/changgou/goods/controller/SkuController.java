...
public class SkuController {
    ...
    /*    @GetMapping("/spu/{spuId}")
        public List<Sku>  function2(@PathVariable("spuId") String spuId){
    ...
    @PostMapping("/decr/cont")
    public Result updateNum(@RequestParam("username") String username){
            skuService.update(username);
            return new Result(true,StatusCode.OK,"修改成功");
    }


    @PutMapping("/resumeStockNum")
    public Result resumeStockNum(@RequestParam("skuId") String skuId,@RequestParam("num") Integer num){
        int i = skuService.resumeStockNum(skuId,num);
